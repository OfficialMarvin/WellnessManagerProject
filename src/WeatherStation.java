...
public class WeatherStation extends Observable implements Runnable {
    ...
    public synchronized double getFarenheit(){return (getCelsius() * 1.8 + 32);
    }

    public synchronized double getInches(){return barReading;}

    public synchronized double getMillibars(){return barReading * 33.864;}
}
